...
<form method="post" action="listaex1">
    ...
    <div class="mb-3">
        <label for="nota1" class="form-label">Informe o primeiro</label>
        <input type="number" id="nota1" name="nota1" class="form-control" required="">
    </div>
                    
    <div class="mb-3">
        <label for="nota2" class="form-label">Informe o segundo</label>
        <input type="number" id="nota2" name="nota2" class="form-control" required="">
    </div>
                    
    <div class="mb-3">
        <label for="nota3" class="form-label">Informe o terceiro</label>
